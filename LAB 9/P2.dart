  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: Column(
            children: [
              qvotecard(text: "how wouid you desc your mood after using our product for first time",author: "denish"),
              qvotecard(text: "How wouid you rate this product",author: "denish"),
              qvotecard(text: "Your feedback",author: "denish"),
            ]
        ),
      ),
    );
